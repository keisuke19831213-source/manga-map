...
export const WORKS: Work[] = [
  ...
  { id: "basara", title: "BASARA", author: "田村由美", year: 1990, magazine: "別冊少女コミック", genres: ["shojo_romance"], desc: "文明崩壊後の日本で、双子の兄に代わり「運命の子」を演じる更紗の革命譚。少女マンガに骨太な戦記と国づくりを持ち込んだ大河。" },
  ...
  { id: "mystery_nakare", title: "ミステリと言う勿れ", author: "田村由美", year: 2016, magazine: "月刊flowers", genres: ["shonen_mystery"], desc: "巻き込まれ体質の大学生・久能整が、推理ではなく問い返す言葉で事件と人の思い込みをほどく。会話そのものを推理劇にした異色作。" },
